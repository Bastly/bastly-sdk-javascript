function AudioSynthView(bastly) {
	...
	var fnPlayNote = function(note, octave) {
        bastly.send("musicSynth", {note:note, octave:octave, selectSound:selectSound.value}, function(a,b){
            console.log('sendMusicData');
            console.log('sendMusicData',a,b);
        });
    ...
    if(bastly){
        bastly.subscribe("musicSynth", function(data, from){
            console.log('got music data');
            console.log(data.from, bastly.from);
            if(data.from !== bastly.from){
                console.log('play! music data');
                console.log(data);
                console.log(data);

                src = __audioSynth.play(data.selectSound, data.note, data.octave, 2);
            }
        });
    }
